let gql,uuid,createRepository,ListSortmentEnum;_94a‍.x([["typeDefs",()=>typeDefs],["resolvers",()=>resolvers]]);_94a‍.w("apollo-server-express",[["gql",["gql"],function(v){gql=v}]]);_94a‍.w("uuid",[["*",null,function(v){uuid=v}]]);_94a‍.w("../../io/Database/createRepository",[["default",["createRepository"],function(v){createRepository=v}]]);_94a‍.w("../List/List",[["ListSortmentEnum",["ListSortmentEnum"],function(v){ListSortmentEnum=v}]]);
...
`;
    ...
    Mutation: {
        ...
        disabledClient: async (_, { input }) => {
            ...
            if(!currentClient.disabled)
                throw new Error(`Client "${input.id}" is already enabled.`);
